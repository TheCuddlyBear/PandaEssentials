...
public final class PandaEssentials extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        tool_lore.add(ChatColor.GRAY + "Opens the Armor Stand Editor on left click");
        ...
        //Events
        getServer().getPluginManager().registerEvents(new ArmorStandMenuHandler(this), this); // Work in progress! Use command instead
        getServer().getPluginManager().registerEvents(new MenuItemClick(this), this);
    }
